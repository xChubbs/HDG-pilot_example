...
CMx = kron(axz',CMz_hat) - kron(axy',CMz_hat);
CMy = kron(ayx',CMz_hat) - kron(ayz',CMx_hat);
CMz = kron(azx',CMy_hat) - kron(azy',CMx_hat);
...
% Permutation of preducts to match form
CMx = permute(CMx, [2, 1, 3]);
CMy = permute(CMy, [2, 1, 3]);
CMz = permute(CMz, [2, 1, 3]);
